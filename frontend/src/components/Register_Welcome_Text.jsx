    ...
    return (
        <div className='text-base px-28 pt-16'>
            ...
            <label htmlFor="text" className='text-xs mb-1'>Full Name</label>
                <input className='mb-2 border-blue-700 w-[90%] mb-4 outline-none border-2 py-1 px-2 rounded-md' type="text" name="fname" id="fname" placeholder='full name' />

                <label htmlFor="text" className='text-xs mb-1'>Your Origin</label>
                <input className='mb-2 border-blue-700 w-[90%] mb-4 outline-none border-2 py-1 px-2 rounded-md' type="text" name="origin" id="origin" placeholder='origin' />
